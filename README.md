      ...
      - Add this syslog-ng source s_r2s. you should change the paramters (see parameters description below the following snippet)
        ...
        source s_r2s{
            python(
              ...
              options("alerts_url","https://url.to.alerts.endpoint/example")
              options("events_url","https://url.to.events.endpoint/example")
              options("api_key","your_api_key")
              options("client_id","your_client_id")
              options("client_secret","your_client_secret")
              options("max_pages",0)
              options("extensions","pcasb_alerts,pcasb_events")
              ...
              options('pcasb_alerts.api_paginator_module','r2s.extensions.proofpoint.pcasb.alerts_paginator')
              options('pcasb_alerts.api_paginator_class','PCASBAlertsPaginator')
              options('pcasb_events.formatter_module','r2s.extensions.proofpoint.pcasb.events_formatter')
              options('pcasb_events.formatter_class','PCASBEventsFormatter')
              options('pcasb_events.api_adaptor_module','r2s.extensions.proofpoint.pcasb.events_api_adaptor')
              options('pcasb_events.api_adaptor_class','PCASBEventsAPIAdaptor')
              options('pcasb_events.api_paginator_module','r2s.extensions.proofpoint.pcasb.events_paginator')
              options('pcasb_events.api_paginator_class','PCASBEventsPaginator')              
            );
        };
        ```
